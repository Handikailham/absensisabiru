...
<body class="bg-gray-100 min-h-screen">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
            <div class="p-6">
                <h1 class="text-3xl font-semibold text-center text-blue-600 mb-6">Data Posisi</h1>
                ...
                <div class="flex justify-between items-center mb-4">
                    <a href="{{ route('posisi.tambah') }}" class="bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 shadow-md">Tambah Posisi</a>
                </div>
                    ...
                    <table class="w-full table-auto border-collapse border border-gray-300 rounded-lg overflow-hidden">
                        <thead>
                            <tr class="bg-gray-200 text-gray-700">
                                ...
                                <th class="border border-gray-300 px-6 py-3">Nama Posisi</th>
                            ...
                            <tr class="hover:bg-gray-100 text-center border-b">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center space-x-2">
                                        <a href="{{ route('posisi.edit', $data->id) }}" class="bg-yellow-500 text-white px-3 py-1 rounded-lg hover:bg-yellow-600 shadow-md">
                                            Edit
                                        </a>
