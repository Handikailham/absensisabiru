...
<body class="bg-gray-100 py-10">
  <h2 class="text-3xl font-bold text-center text-blue-500 mb-6">Edit Data Karyawan</h2>
  ...
  <div class="max-w-lg mx-auto bg-white p-6 rounded-md shadow-md">
    ...
    <form action="{{ route('admin.update', $karyawan->id) }}" method="POST" class="space-y-4">
      @csrf
      @method('PUT')
